...
function pickMany(items: string[], index: number): string[] {
...
async function seed(): Promise<void> {
  await connectDB();
  if (APPEND_ONLY) {
    await seedAdditionalParticipants();
  ...
  const [cPurwakarta, cBekasi, cKarawang, cBandung, cJakarta, cSubang] =
    await City.insertMany([
      {
        name: "Purwakarta",
        normalizedName: "purwakarta",
        province: "Jawa Barat",
        country: "Indonesia",
      },
      {
        name: "Bekasi",
        normalizedName: "bekasi",
        province: "Jawa Barat",
        country: "Indonesia",
      },
      {
        name: "Karawang",
        normalizedName: "karawang",
        province: "Jawa Barat",
        country: "Indonesia",
      },
      {
        name: "Bandung",
        normalizedName: "bandung",
        province: "Jawa Barat",
        country: "Indonesia",
      },
      {
        name: "Jakarta",
        normalizedName: "jakarta",
        province: "DKI Jakarta",
        country: "Indonesia",
      },
      {
        name: "Subang",
        normalizedName: "subang",
        province: "Jawa Barat",
        country: "Indonesia",
      },
    ]);
  ...
  const [
    ...
    { name: "Assistant Manager", normalizedName: "assistant manager" },
    {
      ...
      normalizedName: "senior assistant manager",
    },
  ...
  const pRaw: PRaw[] = [
    // --- PT Seyang Activewear (co 0, iPakaianJadi) ---
    {
      ...
      dept: "HR",
      jabatan: "HR Manager",
      jenisLayanan: "Industri Pakaian Jadi",
      companyEmail: "aan.p@seyang.co.id",
      phone: "081211110001",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Purnama Asih Sur (co 1, iManufaktur) ---
    {
      ...
      dept: "IT",
      jabatan: "Supervisor",
      jenisLayanan: "Manufaktur",
      companyEmail: "aang.en@purnama.co.id",
      phone: "081211110002",
      type: "participant",
      status: "checked_in",
    },
    ...
    {
      fullName: "Acep Irawan",
      coIdx: 2,
      ind: iOtomotif!,
      jt: jtITStaff!,
      city: cPurwakarta!,
      dept: "IT",
      jabatan: "IT Staff / IT Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "acep.i@adient.co.id",
      phone: "081211110003",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Dong Yang Illust (co 3, iManufaktur) ---
    {
      ...
      jabatan: "Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "achmad.f@dongyang.co.id",
      phone: "081211110004",
      type: "participant",
      status: "checked_in",
    },
    // --- PT SANWA MUSEN (co 4, iElektronik) ---
    {
      ...
      dept: "HR",
      jabatan: "SUPERVISOR",
      jenisLayanan: "Komponen Elektronik",
      companyEmail: "afridar.m@sanwa.co.id",
      phone: "081211110005",
      type: "participant",
      status: "checked_in",
    },
    // --- PT PK Manufacturing (co 5, iManufaktur) ---
    {
      ...
      jenisLayanan: "Manufaktur",
      companyEmail: "agus.m@pkmanufacturing.co.id",
      phone: "081211110006",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Japfa (co 6, iAgribisnis) ---
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "ahmad.zz@japfa.co.id",
      phone: "081211110007",
      type: "participant",
      status: "checked_in",
    },
    ...
    {
      fullName: "Akhmad Eka Hadi",
      coIdx: 7,
      ind: iTekstil!,
      jt: jtHRGAStaff!,
      city: cPurwakarta!,
      dept: "HR",
      jabatan: "HR / GA Staff / Manager",
      jenisLayanan: "Tekstil",
      companyEmail: "akhmad.eh@indorama.co.id",
      phone: "081211110008",
      type: "participant",
      status: "checked_in",
    },
    // --- PT SH Garment (co 8, iTekstil) ---
    {
      ...
      jabatan: "Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "andi.dd@shgarment.co.id",
      phone: "081211110009",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Multi Warna Karpetindo (co 9, iTekstil) ---
    {
      ...
      jabatan: "Supervisor",
      jenisLayanan: "Manufaktur",
      companyEmail: "andi.ws@multiwarna.co.id",
      phone: "081211110010",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Andi Widhia Sulistya",
      coIdx: 9,
      ind: iTekstil!,
      jt: jtHRGAStaff!,
      city: cPurwakarta!,
      ...
      jabatan: "HR / GA Staff / Manager",
      jenisLayanan: "Tekstil",
      companyEmail: "andi.ws2@multiwarna.co.id",
      phone: "081211110011",
      type: "participant",
      status: "checked_in",
    },
    // --- PT INDONESIA SIMON (co 10, iAlasKaki) ---
    {
      ...
      dept: "IT",
      jabatan: "ASSISTANT MANAGER",
      jenisLayanan: "Alas Kaki",
      companyEmail: "andina.v@indonesiasimon.co.id",
      phone: "081211110012",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Hitachi Construction (co 11, iManufaktur) ---
    {
      ...
      city: cPurwakarta!,
      dept: "HR",
      jabatan: "Senior asst. Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "andrianto@hitachi-cm.co.id",
      phone: "081211110013",
      type: "participant",
      status: "checked_in",
    },
    // --- PT FURUKAWA INDOMOBIL (co 12, iAkumulator) ---
    {
      ...
      jenisLayanan: "Akumulator Listrik",
      companyEmail: "andrie.h@furukawa-im.co.id",
      phone: "081211110014",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Malindo Feedmill (co 13, iAgribisnis) ---
    {
      ...
      jenisLayanan: "Manufaktur",
      companyEmail: "angga@malindo.co.id",
      phone: "081211110015",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Besland Pertiwi (co 14, iManufaktur) ---
    {
      ...
      jabatan: "Asmen",
      jenisLayanan: "Manufaktur",
      companyEmail: "anna.r@besland.co.id",
      phone: "081211110016",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Yamaha Motor Parts (co 15, iOtomotif) ---
    {
      ...
      jabatan: "HRGA Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "antonius.w@yamaha-parts.co.id",
      phone: "081211110017",
      type: "participant",
      status: "approved",
    },
    {
      fullName: "Bintang Nurul H",
      coIdx: 15,
      ind: iOtomotif!,
      jt: jtSupervisor!,
      city: cKarawang!,
      ...
      jenisLayanan: "Otomotif",
      companyEmail: "bintang.nh@yamaha-parts.co.id",
      phone: "081211110018",
      type: "participant",
      status: "approved",
    },
    // --- PT Astra Honda Motor (co 16, iOtomotif) ---
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "cahyo.p@ahm.co.id",
      phone: "081211110019",
      type: "participant",
      status: "approved",
    },
    ...
    // --- PT Seyang (additional) ---
    {
      ...
      jabatan: "IT Manager",
      jenisLayanan: "Industri Pakaian Jadi",
      companyEmail: "farhan.m@seyang.co.id",
      phone: "081211110022",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Gita Rahayu",
      coIdx: 0,
      ind: iPakaianJadi!,
      jt: jtHRGAStaff!,
      city: cPurwakarta!,
      ...
      jabatan: "HR / GA Staff",
      jenisLayanan: "Industri Pakaian Jadi",
      companyEmail: "gita.r@seyang.co.id",
      phone: "081211110023",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Indo-Rama (additional) ---
    {
      ...
      jenisLayanan: "Tekstil",
      companyEmail: "hendra.k@indorama.co.id",
      phone: "081211110024",
      type: "participant",
      status: "checked_in",
    },
    {
      ...
      jabatan: "Assistant Manager",
      jenisLayanan: "Tekstil",
      companyEmail: "indah.p@indorama.co.id",
      phone: "081211110025",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Adient (additional) ---
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "joko.s@adient.co.id",
      phone: "081211110026",
      type: "participant",
      status: "checked_in",
    },
    {
      ...
      jabatan: "Supervisor",
      jenisLayanan: "Otomotif",
      companyEmail: "kartika.s@adient.co.id",
      phone: "081211110027",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Dong Yang (additional) ---
    {
      ...
      jabatan: "HRGA Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "lukman.h@dongyang.co.id",
      phone: "081211110028",
      type: "participant",
      status: "approved",
    },
    // --- PT SANWA (additional) ---
    {
      ...
      jabatan: "HR / GA Staff",
      jenisLayanan: "Komponen Elektronik",
      companyEmail: "mira.a@sanwa.co.id",
      phone: "081211110029",
      type: "participant",
      status: "checked_in",
    },
    {
      ...
      jabatan: "IT Staff",
      jenisLayanan: "Komponen Elektronik",
      companyEmail: "nanang.s@sanwa.co.id",
      phone: "081211110030",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Hitachi (additional) ---
    {
      ...
      jabatan: "Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "oki.f@hitachi-cm.co.id",
      phone: "081211110031",
      type: "participant",
      status: "rejected",
    },
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "putri.h@hitachi-cm.co.id",
      phone: "081211110032",
      type: "participant",
      status: "checked_in",
    },
    // --- PT PK Manufacturing (additional) ---
    {
      ...
      jabatan: "HRBP Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "qori.a@pkmanufacturing.co.id",
      phone: "081211110033",
      type: "participant",
      status: "checked_in",
    },
    {
      ...
      jabatan: "IT Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "rizky.a@pkmanufacturing.co.id",
      phone: "081211110034",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Japfa (additional) ---
    {
      ...
      jabatan: "Assistant Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "sari.du@japfa.co.id",
      phone: "081211110035",
      type: "participant",
      status: "approved",
    },
    // --- PT SH Garment (additional) ---
    {
      ...
      jabatan: "Supervisor",
      jenisLayanan: "Tekstil",
      companyEmail: "teguh.p@shgarment.co.id",
      phone: "081211110036",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Ulfah Nurdiana",
      coIdx: 8,
      ind: iTekstil!,
      jt: jtHRGAStaff!,
      city: cPurwakarta!,
      ...
      jabatan: "HR / GA Staff",
      jenisLayanan: "Tekstil",
      companyEmail: "ulfah.n@shgarment.co.id",
      phone: "081211110037",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Multi Warna (additional) ---
    {
      ...
      jabatan: "Manager",
      jenisLayanan: "Tekstil",
      companyEmail: "vicky.r@multiwarna.co.id",
      phone: "081211110038",
      type: "participant",
      status: "checked_in",
    },
    // --- PT INDONESIA SIMON (additional) ---
    {
      ...
      jabatan: "HRGA Manager",
      jenisLayanan: "Alas Kaki",
      companyEmail: "wahyu.t@indonesiasimon.co.id",
      phone: "081211110039",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Xenia Pratiwi",
      coIdx: 10,
      ind: iAlasKaki!,
      jt: jtAsstManager!,
      city: cPurwakarta!,
      ...
      jabatan: "Assistant Manager",
      jenisLayanan: "Alas Kaki",
      companyEmail: "xenia.p@indonesiasimon.co.id",
      phone: "081211110040",
      type: "participant",
      status: "checked_in",
    },
    // --- PT FURUKAWA (additional) ---
    {
      ...
      jabatan: "Supervisor",
      jenisLayanan: "Akumulator Listrik",
      companyEmail: "yoga.p@furukawa-im.co.id",
      phone: "081211110041",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Malindo (additional) ---
    {
      ...
      jabatan: "HR / GA Staff",
      jenisLayanan: "Manufaktur",
      companyEmail: "zahra.f@malindo.co.id",
      phone: "081211110042",
      type: "participant",
      status: "pending",
    },
    // --- PT Besland (additional) ---
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "arief.b@besland.co.id",
      phone: "081211110043",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Bella Susanti",
      coIdx: 14,
      ind: iManufaktur!,
      jt: jtKepDiv!,
      city: cPurwakarta!,
      ...
      jenisLayanan: "Manufaktur",
      companyEmail: "bella.s@besland.co.id",
      phone: "081211110044",
      type: "participant",
      status: "approved",
    },
    // --- PT Astra Honda (additional) ---
    {
      ...
      jabatan: "Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "chandra.w@ahm.co.id",
      phone: "081211110045",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Dian Rahmawati",
      coIdx: 16,
      ind: iOtomotif!,
      jt: jtHRBPManager!,
      city: cBekasi!,
    ...
    // --- PT Len Industri (additional) ---
    {
      ...
      jabatan: "IT Manager",
      jenisLayanan: "Komponen Elektronik",
      companyEmail: "erwin.s@len.co.id",
      phone: "081211110047",
      type: "participant",
      status: "pending",
    },
    {
      ...
      jabatan: "HR / GA Staff",
      jenisLayanan: "Komponen Elektronik",
      companyEmail: "fitri.h@len.co.id",
      phone: "081211110048",
      type: "participant",
      status: "pending",
    },
    // --- PT Yamaha (additional) ---
    {
      ...
      jabatan: "HR Manager",
      jenisLayanan: "Otomotif",
      companyEmail: "galih.p@yamaha-parts.co.id",
      phone: "081211110049",
      type: "participant",
      status: "checked_in",
    },
    // --- PT Purnama Asih Sur (additional) ---
    {
      ...
      jabatan: "Assistant Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "hani.s@purnama.co.id",
      phone: "081211110050",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Imam Santoso",
      coIdx: 1,
      ind: iManufaktur!,
      jt: jtHRGAManager!,
      city: cPurwakarta!,
      ...
      jabatan: "HRGA Manager",
      jenisLayanan: "Manufaktur",
      companyEmail: "imam.s@purnama.co.id",
      phone: "081211110051",
      type: "participant",
      status: "checked_in",
    },
    {
      fullName: "Julia Wulandari",
      coIdx: 1,
      ind: iManufaktur!,
      jt: jtSupervisor!,
      city: cPurwakarta!,
      ...
      jabatan: "Supervisor IT",
      jenisLayanan: "Manufaktur",
      companyEmail: "julia.w@purnama.co.id",
      phone: "081211110052",
      type: "participant",
      status: "approved",
    },
    // --- PT Seyang (exhibitor) ---
    {
      ...
      jenisLayanan: "Industri Pakaian Jadi",
      companyEmail: "kevin.h@seyang.co.id",
      phone: "081211110053",
      type: "exhibitor",
      status: "approved",
    },
    {
      fullName: "Lena Agustin",
      coIdx: 2,
      ind: iOtomotif!,
      jt: jtManager!,
      city: cJakarta!,
      ...
      jenisLayanan: "Otomotif",
      companyEmail: "lena.a@adient.co.id",
      phone: "081211110054",
      type: "exhibitor",
      status: "approved",
    },
    {
      fullName: "Mario Effendi",
      coIdx: 12,
      ind: iAkumulator!,
      jt: jtSupervisor!,
      city: cJakarta!,
      ...
      jenisLayanan: "Akumulator Listrik",
      companyEmail: "mario.e@furukawa-im.co.id",
      phone: "081211110055",
      type: "exhibitor",
      status: "checked_in",
    },
  ...
  const pickMany = (items: string[], index: number): string[] => {
    const first = items[index % items.length]!;
    const second = items[(index + 1) % items.length]!;
    return index % 2 === 0 ? [first, second] : [first];
  };
  ...
  const registrations = participantDocs.map((participant, i) => {
    ...
    const approvedAt = isApproved ? new Date("2025-10-01T10:00:00Z") : null;
    ...
    return {
      ...
      approval: {
        ...
        rejectionReason: isRejected
          ? "Kuota departemen sudah terpenuhi."
          : null,
      },
